...
int RecvC2SPacket(SOCKET clientSock, int clientID)
{
	...
	case PACKET_TYPE_KEY_INPUT: {
		...
		Player[clientID].Control[1] = keyInputPacket.keyInput.up;
		Player[clientID].Control[2] = keyInputPacket.keyInput.down;
		Player[clientID].Control[3] = keyInputPacket.keyInput.right;
		Player[clientID].Control[4] = keyInputPacket.keyInput.left;
		Player[clientID].Control[0] = keyInputPacket.keyInput.action;
